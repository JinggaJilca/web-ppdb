...
<head>
  ...
  <title>Menunggu Konfirmasi - Sekolahku</title>
</head>
    ...
    <div class="container-fluid">
      <div class="row">
                  ...
                  <div class="accordion-item bg-transparent" style="border:none;">
                    ...
                    <div id="panelsStayOpen-isiPendaftar" class="accordion-collapse collapse show"
                      ...
                      <div class="accordion-body bg-transparent ms-3">
                        <a href="menunggu.php" style="text-decoration:none;" class="text-secondary mb-2">
                          <div class="d-inline-flex align-items-center mb-2"><i
                              class='bi bi-person-fill-exclamation fs-5 me-2'></i>Menunggu Konfirmasi</div>
                        </a>
        ...
        <div class="col-lg-10 col-md-12 offset-lg-2 px-3 mt-3">
          ...
          <!-- Sidebar Small End -->
          <h4 class="fw-bold">Menunggu Konfirmasi</h4>
          <div class="text-muted">Data di bawah ini membutuhkan aksi dari
            <?= $_SESSION['user']; ?>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-10 col-md-12 offset-lg-2">
            <div class="w-100 p-3 rounded-3 bg-white shadow-md">
              <h6>Tabel Menunggu Konfirmasi</h6>
              <hr>
              <!-- Table Start -->
              <table id="allData" class="dish5lay nowrap table table-striped" style="width:100%;">
                <thead>
                  <tr>
                    <th>No</th>
                    <th>Aksi</th>
                  ...
                  <?php while ($row = mysqli_fetch_assoc($data)): ?>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <button type="button" class="btn text-light" style="background-color:#F59520;"
                            ...
                            <div class="modal-dialog modal-md">
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h1 class="modal-title fs-5 fw-bold" id="staticBackdropLabel">Seleksi Pendaftar</h1>
                                ...
                                <div class="modal-body p-3">
                                  <form action="" method="post" class="needs-validation" novalidate>
                                    ...
                                    <div class="row mb-3 g-3 d-flex align-items-center">
                                      ...
                                      <div class="col-8">
                                        <textarea class="form-control" id="alamat" name="alamat" rows="2" readonly
                                    ...
                                    <div class="modal-footer">
                                      <button type="submit" name="submit-tolak"
                                        class="btn btn-danger py-2 px-4">Tolak</button>
                                      <button type="submit" name="submit-terima"
                                        class="btn py-2 px-4 btn-primary">Terima</button>
                                    </div>
                                  </form>
                                </div>
                              </div>
