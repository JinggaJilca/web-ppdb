...
if (isset($_POST['submit-seragam'])) {
  $id = $_POST['id'];
  if (terima_barang($id, 'seragam')) {
    header('Location: seragam.php');
  }
    ...
    <div class="row">
      <div class="col-lg-10 offset-lg-2 col-md-12">
        <div class="w-100 p-3 rounded-3 bg-white shadow-md">
          <h6>Tabel Pengambilan Seragam</h6>
          <hr>
          <!-- Table Start -->
              ...
              <?php while ($row = mysqli_fetch_assoc($data)): ?>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button type="button" class="btn text-light" style="background-color:#32B47D;" data-bs-toggle="modal"
                      data-bs-target="#staticBackdrop<?= $row['id']; ?>"><i class="bi bi-eye-fill me-2"></i>View</button>
                    <!-- Modal -->
                          ...
                          <div class="modal-body p-3">
                            <form action="" method="post" class="needs-validation" novalidate>
                              ...
                              <div class="row mb-3 g-3 d-flex align-items-center">
                                ...
                                <div class="col-8">
                                  <input type="text" class="form-control border-0" id="kode_seragam" name="kode_seragam"
                                    value="<?= $row['kode_seragam']; ?>" readonly disabled>
                                </div>
                              </div>

                              <div class="modal-footer">
                                <button type="submit" class="btn btn-dark py-2 px-4" data-bs-dismiss="modal">Tutup</button>
                                <?php if ($row['seragam'] == 0) { ?>
                                  <button type="submit" name="submit-seragam" class="btn py-2 px-4 text-light"
                  ...
                  <td>
                    ...
                    <?php } else { ?>
                      <span class="rounded-pill px-3 py-1 text-light" style="background-color:#F5465C; font-size: 13px;">Belum
                        Diterima</span>
                    <?php } ?>
                  </td>
                  <td>
